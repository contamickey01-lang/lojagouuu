                    ...
                    <div className="flex items-center gap-3">
                        ...
                        {isAdmin && (
                            <Link
                                ...
                                className="hidden lg:flex items-center justify-center w-10 h-10 rounded-xl bg-primary/10 border border-primary/20 hover:bg-primary/20 transition-colors text-primary"
                                title="Painel Admin"
                            >
